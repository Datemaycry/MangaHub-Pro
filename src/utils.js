...
export const getSafeStorage = (k, d) => {
  try {
...
export const setSafeStorage = (k, v) => {
  try {
    localStorage.setItem(k, v);
  } catch (e) {}
};
export const triggerHaptic = (p = 50) => {
...
export const decodeFileToIDB = async (f) => {
  ...
  try {
    const res = await fetch(
      `data:${f.type || "application/octet-stream"};base64,${f.data}`,
    );
...
export const SHELF_THEMES = {
  mahogany: {
    name: "Acajou",
    bookend: {
      background: "linear-gradient(to right, #4a1d15, #2a0f0a)",
      borderLeftColor: "#7a3122",
      borderTopColor: "#7a3122",
    },
    board: {
      background: "linear-gradient(to bottom, #5c2419, #210c08)",
      borderTopColor: "#8a3c2b",
    },
    text: "text-[#e8b688]",
    textShadow:
      "1px 1px 0px rgba(255,255,255,0.15), -1px -1px 0px rgba(0,0,0,0.8)",
    texture:
      'bg-[url("data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSI0IiBoZWlnaHQ9IjQiPjxyZWN0IHdpZHRoPSI0IiBoZWlnaHQ9IjQiIGZpbGw9IiNmZmYiIGZpbGwtb3BhY2l0eT0iMC4wNSIvPjwvc3ZnPg==")] mix-blend-overlay opacity-20',
  },
  birch: {
    name: "Bouleau",
    bookend: {
      background: "linear-gradient(to right, #eaddc5, #c2b294)",
      borderLeftColor: "#fff8eb",
      borderTopColor: "#fff8eb",
    },
    board: {
      background: "linear-gradient(to bottom, #d4c5ab, #a8987a)",
      borderTopColor: "#f5ead5",
    },
    text: "text-[#4a3b2c]",
    textShadow:
      "1px 1px 0px rgba(255,255,255,0.6), 0 0 10px rgba(255,255,255,0.2)",
    texture:
      'bg-[url("data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSI0IiBoZWlnaHQ9IjQiPjxyZWN0IHdpZHRoPSI0IiBoZWlnaHQ9IjQiIGZpbGw9IiMwMDAiIGZpbGwtb3BhY2l0eT0iMC4wMyIvPjwvc3ZnPg==")] mix-blend-overlay opacity-40',
  },
  metal: {
    name: "Acier Brossé",
    bookend: {
    ...
    texture:
      'bg-[url("data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIyIiBoZWlnaHQ9IjIiPjxyZWN0IHdpZHRoPSIyIiBoZWlnaHQ9IjIiIGZpbGw9IiNmZmYiIGZpbGwtb3BhY2l0eT0iMC4wNSIvPjwvc3ZnPg==")] mix-blend-overlay opacity-40',
  },
  glass: {
    name: "Verre Dépoli",
    bookend: {
      background:
        "linear-gradient(to right, rgba(255,255,255,0.3), rgba(56,189,248,0.05))",
    ...
    board: {
      background:
        "linear-gradient(to bottom, rgba(56,189,248,0.2), rgba(255,255,255,0.02))",
      borderTopColor: "#ffffff",
